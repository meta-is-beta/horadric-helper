...
**Currently supported games** (as of version v0.9.1 Beta)
...
_You can specify a version of the library by changing `@v0.9.1` to the desired version. You can also set it to `latest` to always get newest version._
