...
**Currently supported games** (as of version v0.8.3 Beta)
...
```url
https://cdn.jsdelivr.net/gh/meta-is-beta/horadric-helper@v0.8.3/dist/poe/horadric-helper-poe.umd.min.js
https://cdn.jsdelivr.net/gh/meta-is-beta/horadric-helper@v0.8.3/dist/poe/horadric-helper-poe.css
```

_You can specify a version of the library by changing `@v0.8.3` to the desired version. You can also set it to `latest` to always get newest version._
