...
**Currently supported games** (as of version v0.8 Beta)
...
```html
<script src="https://cdn.jsdelivr.net/gh/meta-is-beta/horadric-helper@v0.8/dist/poe/horadric-helper-poe.umd.min.js"></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/meta-is-beta/horadric-helper@v0.8/dist/poe/horadric-helper-poe.css" />
```
...
```url
https://cdn.jsdelivr.net/gh/meta-is-beta/horadric-helper@v0.8/dist/poe/horadric-helper-poe.umd.min.js
https://cdn.jsdelivr.net/gh/meta-is-beta/horadric-helper@v0.8/dist/poe/horadric-helper-poe.css
```

_You can specify a version of the library by changing `@v0.8` to the desired version. You can also set it to `latest` to always get newest version._
