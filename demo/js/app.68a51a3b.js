(function (e) {
  ...
  "599e": function (e, t, n) {
    ...
    var i = n("2b0e"),
        ...
        return n("div", { attrs: { id: "app" } }, [
          n("div", { staticClass: "poe-node-demo" }, [
            n(
              ...
              [n("poe-node-showcase", { attrs: { reference: "node-demo" } })],
              1
            ),
          ...
          n("div", { staticClass: "poe-node-demo" }, [
            n(
              ...
              [n("poe-item-showcase", { attrs: { reference: "item-demo" } })],
              1
            ),
        ...
        methods: {
          ...
          registerShowcase: function () {
            window.itemShowcases = window.itemShowcases || {
              items: [],
              applyOptionsByReference: function (e, t) {
                var n = window.itemShowcases.items[e];
                n &&
                  n.forEach(function (e) {
                    e.applyOptions(t);
                  });
              },
              applyOptionsById: function (e, t) {
                var n = Object.values(window.itemShowcases.items);
                if (n) {
            ...
            window.itemShowcases.items[this.reference]
              ? window.itemShowcases.items[this.reference].push(e)
              : (window.itemShowcases.items[this.reference] = [e]);
          },
      ...
      O = E,
      L = (n("55ed"), Object(d["a"])(O, a, r, !1, null, null, null)),
      P = L.exports,
      N = function () {
        var e = this,
          t = e.$createElement,
      ...
      R = G,
      q = (n("caae"), Object(d["a"])(R, A, $, !1, null, null, null)),
      B = q.exports,
      W = {
      ...
      J = W,
      F = (n("6b9d"), Object(d["a"])(J, j, z, !1, null, null, null)),
      K = F.exports,
      Q = {
        nodeData: "",
        displayMode: "",
        ...
        methods: {
          ...
          registerShowcase: function () {
            window.nodeShowcases = window.nodeShowcases || {
              nodes: [],
              applyOptionsByReference: function (e, t) {
                var n = window.nodeShowcases.nodes[e];
                n &&
                  n.forEach(function (e) {
                    e.applyOptions(t);
                  });
              ...
              applyOptionsById: function (e, t) {
                var n = Object.values(window.nodeShowcases.nodes);
                if (n) {
                  var i = n.find(function (t) {
                    return t.id === e;
                  });
            ...
            window.nodeShowcases.nodes[this.reference]
              ? window.nodeShowcases.nodes[this.reference].push(e)
              : (window.nodeShowcases.nodes[this.reference] = [e]);
          },
      ...
      X = V,
      ee = (n("fb7b"), Object(d["a"])(X, N, H, !1, null, null, null)),
      te = ee.exports,
      ne = {
        name: "App",
        components: { PoeItemShowcase: P, PoeNodeShowcase: te },
        data: function () {
          return {
            nodeCustomLabelText: "",
...
//# sourceMappingURL=app.68a51a3b.js.map
